...
****************************************************************************************************/
trigger ValidateCaseComment_tgr on CaseComment (before insert, before update) {
    ValidateCaseComment comment = new ValidateCaseComment();
    comment.executeLogic(Trigger.new, Trigger.old); 
}